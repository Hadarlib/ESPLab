...
{
	infection(3);
    int fd, nread, debug, i, str, close, preP, preA;
    char buf[BUF_SIZE];
    ...
    /* printing adresses */
	system_call(SYS_WRITE,STDOUT,"code line of code_start is:\t",strlen("code line of code_start is:\t"));
  	system_call(SYS_WRITE,STDOUT,itoa((int)code_start),strlen(itoa((int)code_start)));
  	system_call(SYS_WRITE,STDOUT,"\n",strlen("\n"));
  	system_call(SYS_WRITE,STDOUT,"code line of code_end is:\t",strlen("code line of code_end is:\t"));
